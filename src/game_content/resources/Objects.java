...
public class Objects {
	...
	public static final EntityBluePrint BRIDGE_01 = new EntityBluePrint(entityList, 200, ENTITYTYPE.OBJECT, RENDERTYPE.R3X2, "BRIDGE_01", new SpriteAtlas(Sheets.OBJECTS_SHEET, 9, 0, false, 0, 0, false), false, true, true);
