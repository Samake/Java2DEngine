...
public class EffectSmokeWhite extends Effect {
	...
	public EffectSmokeWhite(Level level, float x, float y) {
		super(new EntityConfig(null, 0, ENTITYTYPE.EFFECT, "EFFECT_SMOKE_WHITE", false, new EntityRenderData(new SpriteAtlas(Sheets.EFFECTS_SHEET, 4, 2, true, 100, 8, false), false, true, RENDERTYPE.R1X1)), level, x, y, true, 0);
	}
}
