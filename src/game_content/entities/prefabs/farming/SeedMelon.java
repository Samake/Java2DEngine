...
public class SeedMelon extends Seed {


	public SeedMelon(EntityBluePrint blueprint, Level level, int x, int y) {
							...
							if (entity.equals(this)) {
								if (input.lmouse.isClicked()) {
									if (!cropped && growState == 5) {
										...
										Objects.addInstanceToLevel(Objects.ITEM_MELON, level, (int) position.x + x, (int) position.y + y);
									}
								}
							}
						}
