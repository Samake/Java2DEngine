...
public class EditorGUISlots {
	...
	public static void addEditorSlots(LevelEditor levelEditor, JFrame frame) {
		...
		editorModeTiles.setIcon(IconLoader.getIconfromSheet(Sheets.EDITOR_SHEET, 0, 1, iconScale));
		...
		editorModeEntities.setIcon(IconLoader.getIconfromSheet(Sheets.EDITOR_SHEET, 1, 1, iconScale));
		...
		editorModeLights.setIcon(IconLoader.getIconfromSheet(Sheets.EDITOR_SHEET, 2, 1, iconScale));
		...
		editorModeSounds.setIcon(IconLoader.getIconfromSheet(Sheets.EDITOR_SHEET, 3, 1, iconScale));
		...
		editorModePlayer.setIcon(IconLoader.getIconfromSheet(Sheets.EDITOR_SHEET, 4, 1, iconScale));
		...
		editorModePrefabs.setIcon(IconLoader.getIconfromSheet(Sheets.EDITOR_SHEET, 5, 1, iconScale));
		...
		editorMode7.setIcon(IconLoader.getIconfromSheet(Sheets.EDITOR_SHEET, 6, 1, iconScale));
		...
		editorMode8.setIcon(IconLoader.getIconfromSheet(Sheets.EDITOR_SHEET, 7, 1, iconScale));
