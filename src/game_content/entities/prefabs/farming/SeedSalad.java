...
public class SeedSalad extends Seed {
	...
	public SeedSalad(EntityConfig blueprint, Level level, int x, int y) {
		super(blueprint, level, x, y, 2500);
							...
							if (entity.equals(this)) {
								if (input.lmouse.isClicked()) {
									if (!cropped && growState == 5) {
										...
										Objects.addInstanceToLevel(Objects.ITEM_SALAD, level, (int) position.x + x, (int) position.y + y);
									}
								}
							}
						}
