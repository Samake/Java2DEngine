...
public class Sheets {
	...
	public final static SpriteSheet CLOTHES_SAILOR_SHEET = new SpriteSheet(list, 409, "/textures/characters/clothes/sailor.png", 160);
	public final static SpriteSheet CLOTHES_SKIRT_SHEET = new SpriteSheet(list, 410, "/textures/characters/clothes/skirt.png", 160);
	public final static SpriteSheet CLOTHES_SKULL_SHEET = new SpriteSheet(list, 411, "/textures/characters/clothes/skull.png", 160);
	public final static SpriteSheet CLOTHES_SPAGHETTI_SHEET = new SpriteSheet(list, 412, "/textures/characters/clothes/spaghetti.png", 160);
	public final static SpriteSheet CLOTHES_SPOOKY_SHEET = new SpriteSheet(list, 413, "/textures/characters/clothes/spooky.png", 16);
	public final static SpriteSheet CLOTHES_SPORTY_SHEET = new SpriteSheet(list, 414, "/textures/characters/clothes/sporty.png", 160);
	public final static SpriteSheet CLOTHES_STRIPE_SHEET = new SpriteSheet(list, 415, "/textures/characters/clothes/stripe.png", 160);
	public final static SpriteSheet CLOTHES_SUIT_SHEET = new SpriteSheet(list, 416, "/textures/characters/clothes/suit.png", 160);
	public final static SpriteSheet CLOTHES_WITCH_SHEET = new SpriteSheet(list, 417, "/textures/characters/clothes/witch.png", 16);
	...
	// Beards
	public final static SpriteSheet BEARD_SHEET = new SpriteSheet(list, 525, "/textures/characters/face/beard.png", 224);

	// Ear
	public final static SpriteSheet EAR_EMERALD_SHEET = new SpriteSheet(list, 530, "/textures/characters/ear/earring_emerald.png", 16);
	public final static SpriteSheet EAR_EMERALD_SILVER_SHEET = new SpriteSheet(list, 531, "/textures/characters/ear/earring_emerald_silver.png", 16);
	public final static SpriteSheet EAR_RED_SHEET = new SpriteSheet(list, 532, "/textures/characters/ear/earring_red.png", 16);
	public final static SpriteSheet EAR_RED_SILVER_SHEET = new SpriteSheet(list, 533, "/textures/characters/ear/earring_red_silver.png", 16);
	...
	// Accessoires
	public final static SpriteSheet GLASSES_SHEET = new SpriteSheet(list, 800, "/textures/characters/accessoires/glasses.png", 160);
	public final static SpriteSheet SUN_GLASSES_SHEET = new SpriteSheet(list, 801, "/textures/characters/accessoires/glasses_sun.png", 160);
	public final static SpriteSheet MASK_CLOWN_BLUE_SHEET = new SpriteSheet(list, 802, "/textures/characters/accessoires/mask_clown_blue.png", 16);
	public final static SpriteSheet MASK_CLOWN_RED_SHEET = new SpriteSheet(list, 803, "/textures/characters/accessoires/mask_clown_red.png", 16);
	public final static SpriteSheet MASK_SPOOKY_SHEET = new SpriteSheet(list, 804, "/textures/characters/accessoires/mask_spooky.png", 16);
