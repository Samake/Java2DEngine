...
public class EffectSmokePuffGrey extends Effect {
	...
	public EffectSmokePuffGrey(Level level, float x, float y) {
		super(new EntityConfig(null, 0, ENTITYTYPE.EFFECT, "EFFECT_SMOKEPUFF_GREY", false, new EntityRenderData(new SpriteAtlas(Sheets.EFFECTS_SHEET, 4, 1, true, 100, 8, false), false, true, RENDERTYPE.R1X1)), level, x, y, false, 800);
	}
}
